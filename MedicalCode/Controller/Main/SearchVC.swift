...
//        let patientId = Helper.getPatientID() != nil ? "\(String(describing: Helper.getPatientID()!))" : nil
        let searchData = SearchData(serviceId: "\(String(describing: serviceId!))",patientId: "20182", cityId: "\(String(describing: selectedCityID))", regionId: "\(String(describing: selectedRegionID))", specialityId: "\(String(describing: selectedSpecializationID))", insuranceId: "\(String(describing: selectedInsuranceID))", doctorName: doctorName, page: "1", sortBy: "0", longitude: "", latitude: "", perpage: "100")
        ...
        searchResultVC.searchData = searchData
    }
    //...
}
